        ...
        <>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 justify-between items-center gap-8 ">
                <div className="flex flex-col items-start gap-6 w-fit ">
                    <h3 className="text-[36px] leading-11 font-semibold max-w-[450px]"><span className="text-[#0160C9]">{highlight}</span> {heading} </h3>
                    <p className="text-lg font-normal max-w-lg">{desc}</p>
