...
import productHero from "../../assets/images/product-hero.png"
import ProductVideo from "../../assets/videos/product-page-video.mov"
import Productivity from "../../assets/images/sales-productivity.png"
import Synchronization from "../../assets/images/real-time-synchronization.png"
import Personalized from "../../assets/images/personalized-ai.png"
import Agnostic from "../../assets/images/agnostic-integration.png"
...
import ProductAccordian from "../../assets/images/accordian-thumbnail.png"
    ...
    return (
        <>
                ...
                <div className="container">
                    <div className="flex items-center gap-25">
                        <div className="flex flex-col items-start gap-3 max-w-[560px]">
                            <h1 className="text-[40px] leading-[56px] font-semibold text-start text-[#011A35]">Managing workflows across multiple platforms is chaotic but not with <span className="text-[#0160C9]">dot.it</span> </h1>
            ...
            <section className="pt-20 bg-[#E6EFFA]">
                <div className="container">
                    <h2 className="text-[32px] font-semibold leading-11 text-center">Where sales management meets simplicity</h2>
            ...
            <section className="py-20">
                <div className="container">
                    <h2 className="text-4xl leading-11 font-semibold text-center mt-10">Discover the power behind dot.it's unique features</h2>
                    <div className="mt-3">
