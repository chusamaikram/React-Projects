...
const Cards = [
    ...
    {
        value: "2.4x",
        title: "Efficiency gains in 1 years",
    },
    {
        value: "2.4x",
        title: "Efficiency gains in 1 years",
...
import DetailBg from "/images/case-study-detail-bg.png"
...
export default function CaseStudyDetail() {
    ...
    return (
        <>
            <section className=" mt-[71px] py-20 h-auto lg:h-[450px]  bg-cover bg-center bg-no-repeat " style={{ backgroundImage: `URL(${DetailBg})` }}>
                <div className="container">
                    <div className="mt-20 flex flex-col items-start gap-3 justify-end">
                        ...
                        <div className="grid sm:grid-cols-3 gap-8  max-w-[791px] w-full">
                            {Cards.map((card, index) => (
                                <div key={index} className="p-6 rounded-xl bg-[#FDFDFD] border border-[#F5F5F5] flex flex-col items-start gap-4 w-full">
                                    ...
                                    <span className="text-base leading-6 text-[#5D606D]">{card.title}</span>
                                </div>
                            ))}
